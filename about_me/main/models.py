...
class Work(models.Model):
    organization = models.ForeignKey(Organization,verbose_name='Организация', max_length=200)
...
class Study(models.Model):
    organization = models.ForeignKey(Organization,verbose_name='Наименование учебного учреждения', max_length=200)
    site = models.URLField(verbose_name='Сайт', blank=True)
    region = models.ForeignKey(Region, verbose_name='Регион')
