...
function init(){
    $form = $('#cont_form');
    base_modal_html = $('#cont_modal').html();
}
...
//     $('#cont_modal').html(base_modal_html);
//     $form = $('#cont_form');
// }